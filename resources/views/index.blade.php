        ...
        <div class="container">
            <div class="row g-4 align-items-end mb-4">
                ...
                <div class="col-lg-6 order-lg-1 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <h5 style="font-weight: 600;" class="mb-4 text-muted">From 2022 to 2023 carried out the project team a lot of work in the state archives of the Republic of Kazakhstan, collecting materials from the family archives of Kazakh Germans. The identified set of materials was digitized and systematized into the presented categories. Using the site you will have the opportunity to get acquainted with various topics on the history and culture of the Germans of Kazakhstan. Please note that the site contains electronic copies of archival documents and the site does not provide archive certificates. To obtain archive certificates, you should contact departmental and state archival institutions of the Republic of Kazakhstan.</h5>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row g-4 align-items-end mb-4">
                ...
                <div class="col-lg-6 order-lg-1 wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <h5 style="font-weight: 600;" class="mb-4 text-muted">You can go to “Advanced Search” to see all the publications available on the site, divided into sections, or find the information you need specifically, and click on an area on the map on the right to see all publications related to this area. The same thing can be done using the “Search” menu item. By accessing the “Database” menu item, you can search for a specific person and information about him. If you have materials that you would like to submit for placement on our website, use the “Submit Materials” menu item.</h5>
                    <p class="mb-4 text-muted">All materials on the site are provided for informational purposes only. Partial or complete copying of site materials without written permission from the site administration is prohibited! All materials on the site are protected in accordance with the law, including copyright and related rights.</p>
                    <div class="row">
                        <div class="col-12 col-md-6 mb-3 mb-md-0">
                            <button class="btn btn-primary py-3 px-5 w-100" style="background-color: #0769B4;">Open the map</button>
                        </div>
