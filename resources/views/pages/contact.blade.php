            ...
            <div class="col-md-6 order-lg-2 order-md-2">
                <div class="illustration d-flex flex-column justify-content-center" style="position: relative;">
                    ...
                    <div class="suggest-sidebar mb-5">
                        <h6 class="text-primary">{{ __('contact.titletext') }}</h6>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                ...
                <div class="form-container mt-4">
                    <h4 class="mb-3">{{ __('contact.contact') }}</h4>
                    @if(session('success'))
                    ...
                    <form class="contact-form" action="{{ route('contact.submit') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control mb-3 ps-5" id="name" name="name" placeholder="{{ __('contact.placehhname') }}" required>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="tel" class="form-control mb-3 ps-5" id="phone" name="phone" placeholder="{{ __('contact.placehhphonenumber') }}" required>
                        </div>
                        <div class="form-group">
                            <textarea class="form-control mb-3" id="message" name="message" placeholder="{{ __('contact.placehmessag') }}" rows="8" required></textarea>
                        </div>
                        @if($errors->any())
                            <div>
                                <ul>
                        ...
                        @endif
                        <button type="submit" class="btn btn-primary btn-block w-100 p-2">{{ __('contact.send') }}</button>
                    </form>
                </div>
            </div>
