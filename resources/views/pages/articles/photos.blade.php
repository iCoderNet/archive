...
<div class="container">
    ...
    <div class="row mt-5">
        ...
        <h2 class="text-primary mb-4">Photos</h2>
                        ...
                        <div class="card article-card">
                            <div class="row">
                                <div class="col-lg-6 col-12">
                                    <a href="{{ route('articles.photo', $article->id) }}">
                                        <img src="{{ asset('uploads/' . $photos_[$article->id]->image) }}" class="card-img-top" alt="Image 1">
                                    </a>
                                </div>
                                <div class="col">
                                    <div class="card-body">
