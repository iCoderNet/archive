...
<div class="container">
    ...
    <div class="row mt-5">
        ...
        <h2 class="text-primary mb-4">Videos</h2>
                                ...
                                <div class="col-lg-6 col-12">
                                    <div class="slider-dur">
                                        <a href="{{ route('articles.video', $article->id) }}">
                                            <img src="{{ asset('uploads/'.$article->cover) }}" class="swiper-img" style="width: 100% !important" alt="Image 1">
                                            <div class="slider-duration">
                                                <i class="bi bi-play-fill"></i>
                                                <span>{{ $article->duration }}</span>
                                            </div>
                                            <!-- <img src="{{ asset('uploads/'.$article->cover) }}" class="card-img-top" alt="Image 1"> -->
                                        </a>
                                    </div>
                                </div>
                                <div class="col">
