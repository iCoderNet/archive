...
!function(e) {
    ...
    function f() {
        ...
        function tM() {
            ...
            function() {
                for (var e in eK = function(e) {
                    ...
                    n && eQ[n].cascade && (eQ[n].color && (t.color = eQ[n].color),
            ...
            function() {
                ...
                eJ) {
                    for (var n in eY[i] = Object.create(e),
                    eJ[i]) {
        ...
        function tH(e, t) {
            ...
            function s(e, t, i, n) {
                var a, s, l, c, m, u, p, d, f, h, $, _, v, y, g, b, x, w = o(e), k = o(t), z = o(i), A = o(n), C = r.distance(w, k), E = r.distance(w, z), T = r.distance(k, z), B = r.distance(t, i), S = T / B, F = (a = t.x,
                s = t.y,
                l = C / S,
                c = i.x,
                m = i.y,
                ...
                }), P = r.distance(w, A) / S, I = Math.abs(r.distance(F.opt1, n) - P), O = Math.abs(r.distance(F.opt2, n) - P);
                return I < O ? {
                    x: F.opt1.x,
                    y: F.opt1.y
                } : {
        ...
        function tG(e, t) {
            ...
            "region" == n ? tV(e) : "state" == n ? tV(tl[e.sm.region]) : "manual" == n && eP.forEach(function(e) {
        ...
        function oe(e, t, o) {
            if (!tN) {
                ...
                tG(e, t),
                er || ec && !B || t ? (tn = i,
                e1.setViewBox(i.x, i.y, i.w, i.h, !1),
        ...
        function oz() {
            if (!(ed.offsetWidth < 1)) {
                ...
                eI.forEach(function(e) {
                    "image" != eY[e.sm.id].type && (e.sm.attributes["stroke-width"] = eY[e.sm.id].border * (ey / eb) * s * 1.25,
        ...
        function o4(n) {
            ...
            Y = 0,
            {
                ...
                pos: function(e, t) {
                    ...
                    o && e && (e.clientX && (F = e.clientY - o.top,
                    O = e.clientX - o.left),
                    e.touches && e.touches[0] && (F = e.touches[0].clientY - o.top,
                            ...
                            !tz.ignore_clicks) {
                                ...
                                !t || (!k || "touchend" != t.type) && (k || "touchstart" != t.type)) {
                                    ...
                                    o.sm.zoomable && ("region" == o.sm.type || tc != o || "out" == o.sm.type))
                                        ...
                                        w != o && w && (n = o,
                                        r = w,
                                        "state" != n.sm.type || "region" != r.sm.type || r.sm.id != n.sm.region) && o0(w),
                                        t && t1.pos(t),
                                        t1.show(o),
                                        k = !0,
                                        oy(o, "over"),
                                        ...
                                        if ("" != s && !oW) {
                                            ...
                                            !Q || l ? l ? window.location.href = s : window.top.location.href = s : (window.open(s, "_blank"),
                                            t1.hide())
                                        }
                                        oB(o, t),
                                        o0(o)
        ...
        function oL(e, t, o) {
            ...
            return p || d ? oP("-1", function() {
                oL(e, t, o)
            }) : i.sm.region && "out" == tz.zoom_level ? oP(i.sm.region, function() {
                oL(e, t, o)
            }) : (x = !0,
